...
// Dummy class data
const classData = [
    { id: 1, time: "09:00 - 10:30", course: "Advanced Mathematics", room: "Room 201", instructor: "Dr. Sarah Johnson", status: "attended" },
    { id: 2, time: "10:45 - 12:15", course: "Computer Science", room: "Lab 105", instructor: "Prof. Michael Chen", status: "attended" },
    { id: 3, time: "13:00 - 14:30", course: "Physics Laboratory", room: "Lab 302", instructor: "Dr. Emily Rodriguez", status: "absent" },
    { id: 4, time: "14:45 - 16:15", course: "English Literature", room: "Room 150", instructor: "Ms. Jennifer Wilson", status: "attended" },
    { id: 5, time: "16:30 - 18:00", course: "Chemistry", room: "Lab 204", instructor: "Dr. Robert Brown", status: "upcoming" },
    { id: 6, time: "18:15 - 19:45", course: "History", room: "Room 301", instructor: "Prof. Lisa Davis", status: "upcoming" }
];
...
function showClassDetails(classId) {
    ...
    if (classItem.status === 'attended' || classItem.status === 'absent') {
        actions = `
            <button class="btn btn-primary" onclick="showAISummary('${classItem.course}')">AI Summary</button>
            <button class="btn btn-secondary" onclick="downloadLecture('${classItem.course}')">Download Lecture</button>
        `;
    }
...
// Optional: handle nav clicks (from nav cards)
